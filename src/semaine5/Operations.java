...
public class Operations {
    ...
    static void operation2(int[] tableau) {
        ...
        System.out.println("Il y a " + nb + " elements qui sont plus grand que 4 ou plus petit que 2 dans le tableau");
    }
    ...
    static void operation5(int[] tableau) {
        int greatest = 0;
        for (int i = 0; i < tableau.length; i++) {
            if (tableau[i] > greatest) greatest = tableau[i];
        }
        System.out.println("Le plus grand élément vaut: " + greatest);
    }
}
